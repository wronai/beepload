...
EOF
    ...
    print_success "Backend service generated"
}
...
EOF
    ...
    print_success "Database initialization generated"
}

# Generate all-in-one backend service
generate_backend_service() {
    print_step "Generating unified backend service"

    # Package.json
    cat > services/package.json << 'EOF'
{
  "name": "upload-system-backend",
  "version": "1.0.0",
  "description": "All-in-one backend for upload system",
  "main": "app.js",
  "scripts": {
    "start": "node app.js",
    "dev": "nodemon app.js"
